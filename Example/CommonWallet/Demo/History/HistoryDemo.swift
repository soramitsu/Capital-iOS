...
final class HistoryDemo: DemoFactoryProtocol {
    var title: String {
        return "History"
    }
    ...
    func setupDemo(with completionBlock: @escaping DemoCompletionBlock) throws -> UIViewController {
        ...
        let historyItemViewModelFactory = HistoryDemoItemViewModelFactory(
            amountFormatterFactory: NumberFormatterFactory(),
            includesFeeInAmount: false,
            transactionTypes: [withdrawType],
            assets: assets,
            localizableDateFormatter: dateFormatter.localizableResource())
...
extension HistoryDemo: DemoHeaderViewModelDelegate {
