...
final class FeeView: BaseFeeView {
    ...
    private func layoutEditingImageViewIfNeeded() {
        ...
        imageView.frame = CGRect(x: bounds.size.width - contentInsets.right - imageSize.width,
    ...
    private func layoutDetailsLabelIfNeeded() {
        ...
        detailsLabel.frame = CGRect(x: originX,
    ...
    private func addEditingImageViewIfNeeded() {
        ...
        self.editingIconImageView = editingImageView
    }
}
