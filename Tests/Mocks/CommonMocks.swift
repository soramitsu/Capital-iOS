...
public class MockNumberFormatterFactoryProtocol: NumberFormatterFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("createTokenFormatter(for: WalletAsset?) -> LocalizableResource<TokenFormatter>",
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.createTokenFormatter(for: asset))
...
public class MockWalletNetworkOperationFactoryProtocol: WalletNetworkOperationFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    public func transferOperation(_ info: TransferInfo) -> CompoundOperationWrapper<Data> {
        
    return cuckoo_manager.call("transferOperation(_: TransferInfo) -> CompoundOperationWrapper<Data>",
            parameters: (info),
            escapingParameters: (info),
            superclassCall:
    ...
    public func withdrawOperation(_ info: WithdrawInfo) -> CompoundOperationWrapper<Data> {
        
    return cuckoo_manager.call("withdrawOperation(_: WithdrawInfo) -> CompoundOperationWrapper<Data>",
            parameters: (info),
            escapingParameters: (info),
            superclassCall:
	...
	public struct __StubbingProxy_WalletNetworkOperationFactoryProtocol: Cuckoo.StubbingProxy {
	    ...
	    func transferOperation<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.ProtocolStubFunction<(TransferInfo), CompoundOperationWrapper<Data>> where M1.MatchedType == TransferInfo {
	        let matchers: [Cuckoo.ParameterMatcher<(TransferInfo)>] = [wrap(matchable: info) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockWalletNetworkOperationFactoryProtocol.self, method: "transferOperation(_: TransferInfo) -> CompoundOperationWrapper<Data>", parameterMatchers: matchers))
	    }
	    ...
	    func withdrawOperation<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.ProtocolStubFunction<(WithdrawInfo), CompoundOperationWrapper<Data>> where M1.MatchedType == WithdrawInfo {
	        let matchers: [Cuckoo.ParameterMatcher<(WithdrawInfo)>] = [wrap(matchable: info) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockWalletNetworkOperationFactoryProtocol.self, method: "withdrawOperation(_: WithdrawInfo) -> CompoundOperationWrapper<Data>", parameterMatchers: matchers))
	    }
	...
	public struct __VerificationProxy_WalletNetworkOperationFactoryProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func transferOperation<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.__DoNotUse<(TransferInfo), CompoundOperationWrapper<Data>> where M1.MatchedType == TransferInfo {
	        let matchers: [Cuckoo.ParameterMatcher<(TransferInfo)>] = [wrap(matchable: info) { $0 }]
	        return cuckoo_manager.verify("transferOperation(_: TransferInfo) -> CompoundOperationWrapper<Data>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    ...
	    @discardableResult
	    func withdrawOperation<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.__DoNotUse<(WithdrawInfo), CompoundOperationWrapper<Data>> where M1.MatchedType == WithdrawInfo {
	        let matchers: [Cuckoo.ParameterMatcher<(WithdrawInfo)>] = [wrap(matchable: info) { $0 }]
	        return cuckoo_manager.verify("withdrawOperation(_: WithdrawInfo) -> CompoundOperationWrapper<Data>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
public class MockWalletCommandFactoryProtocol: WalletCommandFactoryProtocol, Cuckoo.ProtocolMock {
    ...
    public func prepareTransfer(with payload: TransferPayload) -> WalletPresentationCommandProtocol {
        
    return cuckoo_manager.call("prepareTransfer(with: TransferPayload) -> WalletPresentationCommandProtocol",
            parameters: (payload),
            ...
            superclassCall:
                ...
                Cuckoo.MockManager.crashOnProtocolSuperclassCall()
                ,
            defaultCall: __defaultImplStub!.prepareTransfer(with: payload))
	...
	public struct __StubbingProxy_WalletCommandFactoryProtocol: Cuckoo.StubbingProxy {
	    ...
	    func prepareTransfer<M1: Cuckoo.Matchable>(with payload: M1) -> Cuckoo.ProtocolStubFunction<(TransferPayload), WalletPresentationCommandProtocol> where M1.MatchedType == TransferPayload {
	        let matchers: [Cuckoo.ParameterMatcher<(TransferPayload)>] = [wrap(matchable: payload) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockWalletCommandFactoryProtocol.self, method: "prepareTransfer(with: TransferPayload) -> WalletPresentationCommandProtocol", parameterMatchers: matchers))
	    }
	...
	public struct __VerificationProxy_WalletCommandFactoryProtocol: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func prepareTransfer<M1: Cuckoo.Matchable>(with payload: M1) -> Cuckoo.__DoNotUse<(TransferPayload), WalletPresentationCommandProtocol> where M1.MatchedType == TransferPayload {
	        let matchers: [Cuckoo.ParameterMatcher<(TransferPayload)>] = [wrap(matchable: payload) { $0 }]
	        return cuckoo_manager.verify("prepareTransfer(with: TransferPayload) -> WalletPresentationCommandProtocol", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
public class MockCommonWalletContextProtocol: CommonWalletContextProtocol, Cuckoo.ProtocolMock {
	...
	public struct __StubbingProxy_CommonWalletContextProtocol: Cuckoo.StubbingProxy {
	    ...
	    func prepareTransfer<M1: Cuckoo.Matchable>(with payload: M1) -> Cuckoo.ProtocolStubFunction<(TransferPayload), WalletPresentationCommandProtocol> where M1.MatchedType == TransferPayload {
	        let matchers: [Cuckoo.ParameterMatcher<(TransferPayload)>] = [wrap(matchable: payload) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockCommonWalletContextProtocol.self, method: "prepareTransfer(with: TransferPayload) -> WalletPresentationCommandProtocol", parameterMatchers: matchers))
	    }
